...
public class DropNpc
{
	...
	private int				lootingPlayerObjId	= 0;
	...
	/**
	 * @param lootingPlayerObjId
	 *            the lootingPlayerObjId to set
	 */
	public void setBeingLooted(int lootingPlayerObjId)
	{
		this.lootingPlayerObjId = lootingPlayerObjId;
	}
