 ...
 *
 */
public abstract class PlayerLoggedOutListener implements Callback<Player>
{
	/**
	 * This method is invoked when player leaves the game.<br>
	 * This method must be overriden by the implementing listener
	 * 
	 * @param player
	 */
	protected abstract void onLoggedOut(Player player);
	 ...
	 */
	@Override
	public final CallbackResult<?> beforeCall(Player player, Object[] args)
	{
		onLoggedOut(player);
		return CallbackResult.newContinue();
	}
