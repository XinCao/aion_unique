...
public class Account {
    ...
    public String toString() {
        return "Account{" + "id=" + id + ", name=" + name + ", passwordHash=" + passwordHash + ", accessLevel=" + accessLevel + ", membership=" + membership + ", activated=" + activated + ", lastServer=" + lastServer + ", lastIp=" + lastIp + ", ipForce=" + ipForce + ", accountTime=" + accountTime + '}';
    }
}