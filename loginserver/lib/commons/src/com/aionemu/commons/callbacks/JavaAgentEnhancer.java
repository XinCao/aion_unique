...
public class JavaAgentEnhancer implements ClassFileTransformer {
     ...
     * @param listenerClassName Listener class that is used for method
     ...
     * @param listenerClassName method listener
    ...
    /**
     * Checks if method is enhancable. It should be marked with
     * {@link com.aionemu.commons.callbacks.Enhancable} annotation, be not
