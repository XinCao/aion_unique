 ...
 * listener - the current ivocation won't be affected, current implementation
 * allocates all listeners that are going to be invoked before execution.<br>
 * <br> {@link Callback#beforeCall(Object, Object[])} and
 * {@link Callback#afterCall(Object, Object[], Object)} are threated as separate
...
public interface EnhancedObject {
     ...
     * @see com.aionemu.commons.callbacks.CallbackHelper#addCallback(Callback,
     * EnhancedObject)
     */
     ...
     * @see
     * com.aionemu.commons.callbacks.CallbackHelper#removeCallback(Callback,
     * EnhancedObject)
     */
    @SuppressWarnings("unchecked")
