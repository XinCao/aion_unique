...
import com.xincao.loginserver.network.gameserver.clientpackets.CM_ACCOUNT_AUTH;
import com.xincao.loginserver.network.gameserver.clientpackets.CM_ACCOUNT_DISCONNECTED;
import com.xincao.loginserver.network.gameserver.clientpackets.CM_ACCOUNT_LIST;
import com.xincao.loginserver.network.gameserver.clientpackets.CM_ACCOUNT_RECONNECT_KEY;
import com.xincao.loginserver.network.gameserver.clientpackets.CM_GS_AUTH;
...
public class GsPacketHandler {
     ...
     */
    private static final Logger log = LoggerFactory.getLogger(GsPacketHandler.class);
