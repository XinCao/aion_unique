...
public class ArmorMasteryEffect extends BufEffect
{
	...
	public void calculate(Effect effect)
	{
		...
		boolean armorMasterySet = player.getEffectController().isArmorMasterySet(armorType);
	...
	public void startEffect(Effect effect)
	{
		...
		Player player = (Player) effect.getEffector();
		player.getEffectController().setArmorMastery(armorType.getMask());
	}
	...
	public void endEffect(Effect effect)
	{
		...
		Player player = (Player) effect.getEffector();
		player.getEffectController().unsetArmorMastery(armorType.getMask());
	}
}
